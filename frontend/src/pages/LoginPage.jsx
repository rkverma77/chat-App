      ...
      >
        ...
        >
          ...
          <div className="text-center mb-10 mt-2">
            <h1 className="text-[36px] sm:text-[40px] font-bold tracking-tight mb-2 leading-tight" style={{ color: "var(--text-primary)" }}>Welcome</h1>
            <p className="text-[16px]" style={{ color: "var(--text-secondary)" }}>Sign in to your account</p>
          </div>
